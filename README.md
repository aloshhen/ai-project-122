...
Лендинг для кофейни с меню и галереей

## 🚀 Технологии

HTML, CSS, JavaScript (возможно с использованием React для интерактивности), GSAP или Framer Motion для анимаций, Swiper.js для галереи.
